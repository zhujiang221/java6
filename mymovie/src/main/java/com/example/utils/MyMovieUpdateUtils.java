...
public final class MyMovieUpdateUtils {
    /*
...
//    }
    ...
    public static boolean myConnextDatabase(MyFilm myfilm){
        ...
        try {
            ...
            String sql="UPDATE mymovies SET cateid =?, moviename = ?, description = ?, pic =?,htp=? WHERE id= ?";
            ...
            ps.setInt(1,myfilm.getCateid());
            ps.setString(2,myfilm.getMoviename());
            ps.setString(3,myfilm.getDescription());
            ps.setString(4,myfilm.getPic());
            ps.setString(5,myfilm.getHtp());
            ps.setInt(6, myfilm.getId());
