...
public final class MyMovieInsertUtils {
    /*
...
//    }
    ...
    public static boolean myConnextDatabase(MyFilm myfilm){
        ...
        try {
            ...
            String sql="INSERT INTO `mymovie`.`mymovies` (`id`, `cateid`, `moviename`, `description`, `pic`,`htp`) VALUES (?,?,?,?,?,?);";
            ...
            //这里传入sql语句中的参数
            ps.setInt(1, myfilm.getId());
            ps.setInt(2,myfilm.getCateid());
            ps.setString(3,myfilm.getMoviename());
            ps.setString(4,myfilm.getDescription());
            ps.setString(5,myfilm.getPic());
            ps.setString(6,myfilm.getHtp());
